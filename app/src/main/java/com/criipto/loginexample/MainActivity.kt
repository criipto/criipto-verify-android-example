...
import com.criipto.loginexample.ui.LoginState
import com.criipto.loginexample.ui.LoginViewModel
import com.criipto.loginexample.ui.theme.LoginExampleTheme

class MainActivity : ComponentActivity() {
    val loginViewModel = LoginViewModel(LoginState.NotLoggedIn())
        ...
        Box(
            ...
            Row(
                ...
                Column(
                    ...
                    Button(onClick = {
                        onLogin?.invoke(eID.MOCK)
                    }, modifier = buttonModifier) {
                        Text(text = "Login with Mock")
                    }

                    Button(onClick = {
                        onLogin?.invoke(eID.MITID)
                    }, modifier = buttonModifier) {
                        Text(text = "Login with MitID")
                    }

                    Button(onClick = {
                        onLogin?.invoke(eID.SEBANKID)
                    }, modifier = buttonModifier) {
                        Text(text = "Login with SE BankID")
                    }

                    Button(onClick = {
                        onLogin?.invoke(eID.NOBANKID)
                    }, modifier = buttonModifier) {
